...
DEFAULT_VAT_RATE = '0'
# Храним в БД только код ТН ВЭД, без текстового описания: раньше описание
# дублировалось в каждой из ~726 тыс. строк и занимало ~160 МБ.
