...
dsh web                        # запустить Web UI (откроет браузер)
dsh web --no-open              # без автооткрытия браузера
dsh web --port 8080            # на другом порту
dsh web --host 0.0.0.0         # слушать все интерфейсы
dsh --version                  # 0.1.5-rc.2
dsh --help                     # все профили и опции
